                    ...
                    <?= form_open_multipart('' ,'class="needs-validation"') ?>
                            ...
                            <div class="form-group row">
                                <div>
                                    <img style= "width: 130px;height: 120px;"
                                     src="<?= base_url($row['national_id_doc_name']) ?>" alt="No Profile Picture"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style = "display:flex; justify-content: space-between;">
                            ...
                            <div class="form-group row">
                                <div>
                                    <img style= "width: 130px;height: 120px;"
                                     src="<?= base_url($row['high_school_cert_doc_name']) ?>" alt="No Profile Picture"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style = "display:flex; justify-content: space-between;">
                            ...
                            <div class="form-group row">
                                <div>
                                    <img style= "width: 130px;height: 120px;"
                                     src="<?= base_url($row['birth_certificate_doc_name']) ?>" alt="No Profile Picture"/>
                                </div>
                            </div>
                        </div>
                    <?php echo form_close(); ?>
