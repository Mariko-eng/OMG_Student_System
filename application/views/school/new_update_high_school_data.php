            ...
            <div class="card">
                <div class="card-body">
                    <?= form_open_multipart('' ,'class="needs-validation"') ?>
                        ...
                        <div class="form-group row">
                            <label for="islamic_degree" class="col-md-2">Islamic Degree <?= form_error('islamic_degree', '<span style=" color:red;">', '</span>') ?></label>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "A" name = "islamic_degree">A</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "B" name = "islamic_degree">B</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "C" name = "islamic_degree">C</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "D" name = "islamic_degree">D</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "E" name = "islamic_degree">E</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "F" name = "islamic_degree">F</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "Other" name = "islamic_degree">Other</h4>
                        </div>


                        <div class="form-group row">
                            <label for="arabic_degree" class="col-md-2">Arabic Degree <?= form_error('arabic_degree', '<span style=" color:red;">', '</span>') ?></label>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "A" name = "arabic_degree">A</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "B" name = "arabic_degree">B</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "C" name = "arabic_degree">C</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "D" name = "arabic_degree">D</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "E" name = "arabic_degree">E</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "F" name = "arabic_degree">F</h4>
                            <h4 style="color: blueviolet; margin-right: auto;"><input type="radio" value = "Other" name = "arabic_degree">Other</h4>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="exam_no" class="col-md-2 control-label">Exam Number</label>
                            <input required <?= $subtitle == 'view' ? 'disabled' : '' ?> 
                            type="text" class="form-control col-md-10" 
                            maxlength="50" name="exam_no" id="exam_no" 
                            placeholder="Exam N0"
                            value="<?= set_value('exam_no', isset($row) ? $row['exam_no'] : '') ?>">
                        </div>

                        <div class="form-group row">
                            <label for="attempts" class="col-md-2 control-label">Attempts</label>
                            <input required <?= $subtitle == 'view' ? 'disabled' : '' ?> 
                            type="text" class="form-control col-md-10" 
                            maxlength="10" name="attempts" id="attempts" 
                            placeholder="Attempts"
                            value="<?= set_value('attempts', isset($row) ? $row['attempts'] : '') ?>">
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="certificate_date" class="col-md-2 control-label">Certificate Date</label>
                            <input <?= $subtitle == 'view' ? 'disabled' : '' ?> 
                                name="certificate_date" 
                                id="certificate_date"
                                class="form-control col-md-10" required
                                placeholder="Certificate Date"
                                value="<?= set_value('certificate_date')?>">
                        </div>
                        <div class="form-group row">
