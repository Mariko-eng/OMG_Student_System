                ...
                <div class="card-body">
                    <?= form_open_multipart('' ,'class="needs-validation"') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <input required <?= $subtitle == 'view' ? 'disabled' : '' ?> 
                            type="text" class="form-control col-md-10" placeholder="English Degree" 
                        ...
                        <div class="form-group row">
                            ...
                            <input required <?= $subtitle == 'view' ? 'disabled' : '' ?> 
                            type="text" class="form-control col-md-10" placeholder="Math Degree" 
                        ...
                        <div class="form-group row">
                            ...
                            <input required <?= $subtitle == 'view' ? 'disabled' : '' ?> 
                            type="text" class="form-control col-md-10" placeholder="Physics Degree" 
                        ...
                        <div class="form-group row">
                            ...
                            <input required <?= $subtitle == 'view' ? 'disabled' : '' ?> 
                            type="text" class="form-control col-md-10" placeholder="Chemistry Degree" 
                        ...
                        <div class="form-group row">
                            ...
                            <input required <?= $subtitle == 'view' ? 'disabled' : '' ?> 
                            type="text" class="form-control col-md-10" placeholder="Biology Degree" 
